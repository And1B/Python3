...
for item in daily_transactions_split:
  transaction_clean = []
  for value in item:
    transaction_clean.append(value.strip(" ").strip("\n"))
...
total_sales = 0
for strings in sales:
  total_sales += float(strings.strip("$"))
thread_sold_split = []
...
for colors in colors:
  print("The color {} has been sold ".format(colors) + str(color_count(colors)) + " times today")
